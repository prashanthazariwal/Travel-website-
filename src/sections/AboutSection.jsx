  ...
  return (
    <div className="bg-[#121212] w-full  relative overflow-hidden">
        ...
        <div className="lg:px-10">
          <div className="w-full  flex lg:flex-row flex-col mt-[30%]">
            <div className=" w-full lg:w-[20%] pl-8 h-full flex flex-col gap-3">
              <div className="w-full  h-fit flex relative ">
                ...
                <div className="w-14 lg:w-20 h-14 lg:h-20 rounded-full overflow-hidden absolute top-0 left-10 lg:left-14">
                  <img
                    src={travel2}
                    alt=""
                    className="w-full h-full object-cover"
                ...
                <div className="w-14 lg:w-20 h-14 lg:h-20 rounded-full overflow-hidden absolute top-0 left-20 lg:left-32">
                  <img
                    src={travel3}
                    alt=""
                    className="w-full h-full object-cover"
              ...
              <h2 className="text-3xl lg:text-5xl font-semibold text-[#027DEC] ">
                About Us
              </h2>
            </div>
            <div className="w-full lg:w-[80%] h-full px-2 text-white">
              <p className="text-2xl lg:text-4xl font-normal mt-7 ml-7 leading-tight lg:leading-loose">
                ...
                journey ends . As a seasoned traveler, you deserve a companion
                who understands the art of exploration, and{" "}
                <span className="inline-block w-10 lg:w-14  relative ">
                  <img
                    src={suitcase}
                    className="absolute -top-8 lg:-top-12 right-0 w-10 lg:w-14 h-10 lg:h-14 object-cover"
